...
// Inicializar botões de adicionar ao carrinho após DOM estar pronto
...
// Inicializar event listeners do carrinho após DOM estar pronto
document.addEventListener('DOMContentLoaded', function() {
...
async function handleCheckout() {
    ...
    try {
        ...
        alert('Erro ao processar o pagamento. Tente novamente ou entre em contato conosco.');
...
// Inicializar checkout após DOM estar pronto
document.addEventListener('DOMContentLoaded', function() {
    const checkoutBtn = document.getElementById('checkout-btn');
    if (checkoutBtn) {
